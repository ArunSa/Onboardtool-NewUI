...
/**
 * Servlet implementation class application_piechart
 */
@WebServlet("/application_piechart")
public class application_piechart extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public application_piechart() {
        super();
